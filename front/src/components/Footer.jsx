        ...
        <Footer container className='border border-t-8 border-teal-500'>
            <div className='w-full max-w-7xl mx-auto'>
                    ...
                    <div className='grid grid-cols-2 gap-8 sm: mt-4 sm:grid-cols-3 sm:gap-6'>
                        <div>
                            ...
                            <Footer.LinkGroup col>
                                ...
                                <Footer.Link href='/about' target='_blank' rel='noopener noreferrer'>Tara's blog</Footer.Link>
                        ...
                        <div>
                            ...
                            <Footer.LinkGroup col>
                                ...
                                <Footer.Link href='#' rel='noopener noreferrer'>Discord</Footer.Link>
                            </Footer.LinkGroup>
                        </div>
                        <div>
                ...
                <div className='w-full sm:flex sm:items-center sm:justify-between'>
                    <Footer.Copyright href='#' by="Tara's Blog" year={new Date().getFullYear()} />
